...
const STRINGS = {
  en: {
    ...
    observer_viewing: 'Viewing the profile of',
    observer_back: 'Back to my profile',
    stat_rating: 'Rating',
    ...
    tier_Expert: 'Expert',
    'tier_Candidate Master': 'Candidate Master',
    tier_Master: 'Master',
  ...
  ru: {
    ...
    observer_viewing: 'Вы смотрите профиль',
    observer_back: 'Вернуться к своему профилю',
    stat_rating: 'Рейтинг',
    ...
    tier_Newbie: 'Новичок',
    tier_Pupil: 'Ученик',
    tier_Specialist: 'Специалист',
    tier_Expert: 'Эксперт',
    'tier_Candidate Master': 'Кандидат в мастера',
    tier_Master: 'Мастер',
