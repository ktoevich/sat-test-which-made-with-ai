...
const STRINGS = {
  en: {
    ...
    notif_empty: 'Nothing new yet. Friend requests and answers to yours will show up here.',
    notif_friend_request: '{name} wants to be your friend.',
    notif_friend_accepted: '{name} accepted your friend request.',
    notif_other: '{name}',
    ...
    exam_calculator_minimize: 'Minimize or restore the calculator',
  ...
  ru: {
    ...
    notif_empty: 'Пока ничего нового. Здесь появятся заявки в друзья и ответы на ваши.',
    notif_friend_request: '{name} хочет добавить вас в друзья.',
    notif_friend_accepted: '{name} принял(а) вашу заявку в друзья.',
    notif_other: '{name}',
    ...
    exam_calculator_minimize: 'Свернуть или развернуть калькулятор',
